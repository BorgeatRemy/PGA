...
if __name__ == "__main__":
    ...
    GPIO.add_event_detect(BUTTON_START, GPIO.FALLING, callback=callbackStart, bouncetime=400)
    GPIO.add_event_detect(BUTTON_STOP, GPIO.FALLING, callback=callbackStop, bouncetime=400)
