...
for c in cnts:
    ...
    cv2.circle(orig, (int(midX), int(midY)), 5, (255, 255, 0), -1)
    cv2.circle(orig, (int(100), int(00)), 10, (0, 0, 255), -1)
    ...
    print("object number " + str(i) + " pos(x,y) : " + str(midX_m)+ "," + str(midY_m) + " (w,h) : " + str(dimA_m) +  "," + str(dimB_m) + " angle : " + str(alpha_deg) + "delta(x,y)" + str(deltaX) + "," + str(deltaY))
